...
namespace Tests
{
    ...
    {
        [Test]
        public void UsersGetWoParameterTest()
        {
            // Arrange
        ...
        public void UsersGetMethodWithParameterTest()
        {
            // Arrange
            //var mockRepository = new Mock<IMovieRepository>();
            AdPortalDbContext adPortalDbContext = new AdPortalDbContext();
            ...
            //var controller = new ImagesController();
            //var m = new Mock<AdPortalDbContext>();
            var c = new UsersController(adPortalDbContext);
           ...
           /// var c = m.Object;
            ...
            var s = actionResult as OkNegotiatedContentResult<User>;
        ...
        [Test]
        public void UsersPostMethodSetsLocationHeader()
        {
            // Arrange
            var mockRepository = new Mock<AdPortalDbContext>();
            var controller = new ImagesController(mockRepository.Object);
