...
namespace Tests
{
    public class CategoriesContollerTests
    {
        [Test]
        public void CategoriesGetWoParameterTest()
        {
            // Arrange
            ...
            var c = new CategoriesController(adPortalDbContext);
        ...
        public void CategoriesGetMethodWithParameterTest()
        {
            // Arrange
            //var mockRepository = new Mock<IMovieRepository>();
            AdPortalDbContext adPortalDbContext = new AdPortalDbContext();
           ...
           /// var c = m.Object;
            ...
            var s = actionResult as OkNegotiatedContentResult<Category>;
        ...
        [Test]
        public void CategoriesPostMethodSetsLocationHeader()
        {
            // Arrange
            var mockRepository = new Mock<AdPortalDbContext>();
            var controller = new ImagesController(mockRepository.Object);
